...
from orbit_visualiser.core import NewOrbit, NewSatellite
...
def test_circular_orbit_distance_parameters(
    ...
    """
    orbit: NewOrbit = orbit_factory_from_elements(rp = rp)
...
def test_circular_orbit_flight_angle(
    ...
    for nu in closed_anomaly_grid:
        satellite: NewSatellite = satellite_factory_from_elements(rp = rp, mu = mu, nu = nu)
